...
<?php
  ...
  $sql = "SELECT * FROM men WHERE ItemCode='$id'";
...
<html lang="en" dir="ltr">
  ...
  <body>
    <br>
      <a type="button" id="myBtn" class="button3" href="men.php" style="margin-left:25px;background-color: #ee4e0d;">Back</a>

            <form action="action/updateMen.php" method="post" enctype="multipart/form-data">
              <div class="container">
