      ...
      <div id="myModal" class="modal">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form action="action/menInsert.php" method="post" enctype="multipart/form-data">
              <div class="container">
                <div class="container signin">
                  <center>
                    <h1>Insert New Men Item</h1>

                    <p>Please fill in this form Correctly to Insert new Men Item</p>
                  </center>
                </div>
                <hr>
                <center>
    ...
    <table id="myTable">
      ...
      <?php
        ...
        while($row = mysqli_fetch_assoc($records)) {
          ...
          echo "<td>
              <form method='post' action='menFill.php'>
              <input type='hidden' name='id' value=".$row["ItemCode"].">
              <button id=".$count." class='button1'>Edit</button>
              </form>
              <form method='post' action='action/menDel.php' onsubmit='return delAl()'>
              <input type='hidden' name='id' value=".$row["ItemCode"].">
