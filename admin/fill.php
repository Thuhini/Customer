...
<?php
  ...
  $sql = "SELECT * FROM skin WHERE ItemCode='$id'";
...
<html lang="en" dir="ltr">
  ...
  <body>
    <br>
      <a type="button" id="myBtn" class="button3" href="skin.php" style="margin-left:25px;background-color: #ee4e0d;">Back</a>

            <form action="action/updateSkin.php" method="post" enctype="multipart/form-data">
              <div class="container">
