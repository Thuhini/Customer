...
<html lang="en" dir="ltr">
  ...
  <div class="card" style="box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2);transition: 0.3s;width: 33.33%; float:left">
    <img src="images/a.jpg" alt="images/a.jpg" style="width:100%">
      <div class="container" id="cardid" style="padding: 2px 16px;">
        ...
        <p><button id="footbut">Skin Care</button></p>
      </div>
  </div>
  <div class="card" style="box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2);transition: 0.3s;width: 33.33%;float:left">
    <img src="images/b.jpg" alt="images/b.jpg" style="width:100%">
      <div class="container" id="cardid" style="padding: 2px 16px;">
        <h4><b>Make-up</b></h4>
        ...
        <p><button id="footbut">Make-up</button></p>
      </div>
  </div>
  <div class="card" style="box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2);transition: 0.3s;width: 33.33%;float:left">
    <img src="images/c.jpg" alt="images/c.jpg" style="width:100%">
      <div class="container" id="cardid" style="padding: 2px 16px;">
        <h4><b>Fragrance</b></h4>
        ...
        <p><button id="footbut">Fragrance</button></p>
      </div>
  </div>
  <br><br>
  <div class="card" style="box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2);transition: 0.3s;width: 33.33%;float:left">
    <img src="images/b.jpg" alt="images/b.jpg" style="width:100%">
      <div class="container" id="cardid" style="padding: 2px 16px;">
        ...
        <p><button id="footbut">Contact</button></p>
      </div>
  </div>
  <div class="card" style="box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2);transition: 0.3s;width: 33.33%;float:left">
    <img src="images/a.jpg" alt="images/a.jpg" style="width:100%">
      <div class="container" id="cardid" style="padding: 2px 16px;">
        ...
        <p><button id="footbut">Hair</button></p>
      </div>
  </div>
  <br><br><br>
  <div class="card" style="box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2);transition: 0.3s;width: 33.33%;float:left">
